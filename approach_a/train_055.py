"""Exp 055 — image token prepended to essay tokens, joint BERT encoding, CE."""
import os, sys
...
from approach_a.models import BRCAFEarlyFusionCls
from approach_a.trainer import run

RESULTS_DIR = os.path.join(ROOT, 'results', '055', 'results')
MODELS_DIR  = os.path.join(ROOT, 'results', '055', 'models')

CFG = {
    'exp': '055_BRCAFEarlyFusionCls',
...
if __name__ == '__main__':
    ...
    model = BRCAFEarlyFusionCls(d1=CFG['dropout1'], d2=CFG['dropout2'])
